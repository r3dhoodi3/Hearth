...
- Founder concierge-matches the first ~50 jobs by hand: when a job posts, text the 2-3 best pros within the hour, and text the homeowner "2 pros are looking at your job now."
...
4. Pro paid-lead-to-win rate: 30%+ (under 15% = pros will churn)
...
The one signal that cannot be faked: pros re-buying leads with their own money after a win.
Kill trigger: fill rate under 50% or lead-to-win under 15% for 3+ straight weeks despite concierge effort.
...
| 3 | Facebook groups | Join FV Community Forum, Explore FV, HB CommUNITY Voice, HB Community Forum 2.0, HB4U as a resident; 2 weeks of helpful answers; then offer admins a free FV/HB maintenance calendar | $0 | 10-30 signups from one well-received resource post |
...
**Message priority:** lead anti-Angi ("3 vetted local pros, your number never gets sold, no spam calls"), second "your FV/HB home is 50+ years old, know what needs attention before it breaks." Do NOT lead with "AI-powered" to this demographic; keep AI as the live demo wow.
