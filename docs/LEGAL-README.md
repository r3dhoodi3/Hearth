...
- Brand: "Hearth" cannot be the launch brand. Shogun Enterprises holds a live federal trademark on HEARTH for contractor software (gethearth.com), and an iOS app called "Hearth: Home Maintenance" already exists. Not decided yet. Screened options: Keepwell (recommended), Gable, Fixlist, Stoop, Lintel, Doorsill, Wellhouse, Cornice.
