...
export const DESTINATIONS: Destination[] = [
  ...
  { label: "Ask OakTend", href: "/chats?lead=ask-oaktend", keywords: ["ai", "assistant", "question", "chat"], side: "homeowner" },
  ...
  { label: "OakTend Plus and billing", href: "/plus", keywords: ["billing", "subscription", "upgrade", "membership", "plan", "cancel", "pay"], side: "homeowner" },
  ...
  { label: "Ask OakTend", href: "/pro/ask", keywords: ["ai", "copilot", "assistant", "question"], side: "pro" },
