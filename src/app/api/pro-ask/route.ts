...
export async function POST(req: NextRequest) {
  ...
  const system =
    ...
    "Winning work: read a posted lead and draft a persuasive, specific apply message; draft or sharpen a quote or estimate with sensible line items priced to compete locally in the coastal and central Orange County, California area Hearth serves (Huntington Beach, Fountain Valley, Seal Beach, Westminster, Midway City, Garden Grove, Santa Ana, Costa Mesa, and Newport Beach); and give speed-to-lead and follow-up advice, since replying fast wins jobs.\n" +
