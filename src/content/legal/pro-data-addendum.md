# {{BRAND}} Homeowner Data Use Addendum
...
You may use Homeowner Data only for the Permitted Purpose. That is the whole rule. If you are not sure whether a use is inside or outside the Permitted Purpose, ask yourself whether the homeowner would recognize it as something related to the job they posted. If not, do not do it without asking the homeowner first and getting their clear agreement.

## 4. Prohibited uses

Regardless of Section 3, you may never do any of the following with Homeowner Data, even data you have kept in your own CRM notes:

- Sell it, rent it, or otherwise transfer it to anyone outside your own business for money or anything of value.
- Share it with another business, another pro, or any third party who was not involved in performing the job.
- Combine it with other data you hold to build a marketing profile, or add it to a mailing list, newsletter list, or CRM system outside of {{BRAND}}'s own in-app CRM, for any purpose other than the job.
- Use it to retarget the homeowner with ads on any platform, or hand it to an ad network or data broker for that purpose.
- Use it for skip tracing, or to locate or contact the homeowner for any purpose unrelated to the job.
- Use photos of the homeowner's property for your own marketing, portfolio, or advertising without the homeowner's separate written consent, even if you post those same photos on {{BRAND}} as allowed under the Pro Terms.
- Contact the homeowner to solicit a different job, a referral, or a review of unrelated work, unless the homeowner clearly agrees to that first.
...
You must protect Homeowner Data with reasonable safeguards appropriate to what it is: things like not leaving it on a shared or public computer, not emailing it to a personal account outside your business, and not sharing your {{BRAND}} login with anyone else. If you learn of a breach, loss, or unauthorized access involving Homeowner Data, whether it happened on your systems or someone else's, report it to {{SECURITY_EMAIL}} within 72 hours of finding out.

## 8. Subcontractors and employees

If you use a subcontractor, employee, or office staff to help respond to or perform a job, you may share the Homeowner Data they need to do that with them, but you are responsible for making sure they follow the same rules in this addendum. A violation by someone you shared it with counts as your violation for purposes of this addendum and the Pro Terms.

## 9. Audit, certification, and no-sale acknowledgment
...
Nothing here limits a homeowner's rights under {{BRAND}}'s Privacy Policy or under California law, including their right to know what has been done with their information and their right to have it deleted. Where this addendum and a homeowner's exercise of those rights point in different directions, the homeowner's rights control, and you must cooperate with {{BRAND}} in honoring them.

## 11. Survival and governing law

This addendum survives the end of your relationship with {{BRAND}}, however that happens, with respect to any Homeowner Data you received before it ended: your deletion, retention, and security obligations continue to apply to that data even after your account is closed. This addendum is governed by California law, consistent with the governing law and venue provisions in the general Terms of Service.
