...
California law (Civil Code section 1798.100) requires that, at or before the point we collect personal information, we tell you what categories we collect, where they come from, why, how long we keep them, and whether we sell or share them. This table is that notice. Full detail on each row is in Sections 3 and 4.
...
| Commercial information | Jobs you post, quotes, lead purchases, wallet transactions, subscription plan, reviews you write | You; your use of the marketplace | Running the marketplace and your subscription | While account active, plus up to 30 days after deletion | No |
| Internet or network activity | First-party product-usage events (for example, that a job was posted or a video was played); push-notification subscription details | Automatically, from your use of {{BRAND}} | Understanding which features are used; delivering push notifications you opted into | Disconnected from your account (de-identified) within 30 days of a deletion request | No |
...
**If you sign up as a homeowner**, we collect your email; your phone number, if you add one; your name, if you add one; an SMS-consent checkbox and timestamp if you opt into texts; any referral or invite token you used; your property address, which is required, plus city, state, ZIP code, year built, and square footage, which are optional; your home systems and their ages; maintenance tasks and reminders; issues you log; photos and documents you upload; your push-notification subscription; in-app messages you send; reviews you write; blocks or reports you file; and, if you subscribe to {{BRAND}} Plus, a Stripe customer and subscription ID.

**If you sign up as a pro**, we collect everything above that applies to you, plus your business name, your own name as the account owner, your California contractor (CSLB) license number, a snapshot of your license status, your self-reported insurance carrier and expiration date, any license or insurance documents you upload, your background-check status if that feature is enabled for your account, your lead purchases and wallet transactions, the notes you keep on your own clients in {{BRAND}}'s CRM tool, and any responses you write to reviews.
...
{{BRAND}} does not use any third-party analytics service, advertising SDK, ad pixel, retargeting tag, session-recording tool, or heatmap tool. There is no cross-site tracking anywhere in {{BRAND}}, which is why a browser's "Do Not Track" signal doesn't change anything here; see Section 7 for how we do handle the separate Global Privacy Control signal.
...
California law treats some categories of personal information as "sensitive," giving you an extra right to ask that we limit our use of it (see Section 7). For {{BRAND}}, that includes:

- **Precise geolocation.** The latitude and longitude of the home you add, derived automatically from the street address you type. This is not your device's GPS location; {{BRAND}} does not track where your phone or laptop physically is.
...
We use sensitive personal information only for the specific feature that needs it: matching you with pros near you, verifying a pro's license and insurance, answering the question you asked, and running billing. We do not use it to infer anything else about you, to build an advertising profile, or for any purpose beyond what the feature obviously does. Because of that, there is effectively nothing further to restrict beyond our current practice, but California law still gives you the right to **limit the use of your sensitive personal information** to what is reasonably necessary to provide {{BRAND}}. You can exercise that right the same way as the other rights described in Section 7.

## 5. How We Use Your Information

We use the categories described above to:
...
| Vercel | Hosting and serverless functions | Request logs and IP address |
...
Our Subprocessor and Vendor List page has the current, complete list, with a link to each provider's own privacy policy.

### For legal reasons

We may disclose information if we reasonably believe it's necessary to comply with a subpoena, court order, or other legal process, to enforce our Terms, to detect or prevent fraud or a security incident, or to protect the rights, property, or safety of {{BRAND}}, our users, or the public.

### Business transfer

If {{BRAND}} is acquired by, merges with, or sells substantially all of its assets to another company, your information may be transferred as part of that transaction. If that happens in a way that meaningfully changes how your information is handled, we will notify you before the change takes effect.

### With your consent

We may share information for other purposes if you give us your clear, specific consent to do so.

### What we do not do

We do not sell your personal information. We do not share it for cross-context behavioral advertising. We do not work with data brokers, ad networks, or third-party analytics or tracking companies. In the preceding 12 months, we have not sold or shared any personal information, and we have no plans to start.
...
- **Right to know** what we've collected, where it came from, why, and who we've disclosed it to.
- **Right to delete**, subject to the narrow legal exceptions described in Section 12.
- **Right to correct** anything inaccurate that we hold about you.
- **Right to data portability**: a copy of your information in a portable, readily usable format.
- **Right to opt out of sale or sharing.** We do not sell or share your information, so there is nothing to opt out of, but you may still submit this request and we will confirm that in writing.
- **Right to limit the use of sensitive personal information**, described in Section 4.
- **Right to non-discrimination.** We will never deny you service, charge you a different price, or give you a different level of quality because you exercised any of these rights.
...
**Authorized agents.** You may name someone else to submit a request on your behalf. We will ask that agent for proof of your written authorization, and we may still separately verify your own identity before completing the request.

**Response time.** We aim to respond within 45 days of receiving a request we can verify. If we need more time, we will tell you why, and we may take up to another 45 days.

**Appeals.** If we deny a request, you can appeal by replying to our denial or writing to {{PRIVACY_EMAIL}}. We will respond to an appeal within 45 days. If we deny the appeal, we will explain how to file a complaint with the California Privacy Protection Agency.

**Global Privacy Control.** Where your browser sends the Global Privacy Control (GPC) signal, {{BRAND}} treats it as a valid request to opt out of the sale and sharing of your personal information. Because we do not sell or share personal information in the first place, honoring GPC does not change how your data is actually handled, but we think that's worth saying plainly rather than leaving unaddressed.

**Do Not Track.** {{BRAND}} runs no cross-site tracking, so a browser's "Do Not Track" signal does not change anything here; there is no tracking for it to turn off.
...
{{BRAND}} currently serves homeowners in Orange County, California, but people travel, move, and read this policy from other places. If you live in Colorado, Connecticut, Virginia, or another state with a comprehensive consumer privacy law, you generally have rights similar to the ones in Section 7: to know, access, correct, delete, and receive a portable copy of your personal information, and to opt out of the sale of personal information, targeted advertising, and certain kinds of automated profiling. {{BRAND}} does not sell personal information or use it for targeted advertising for anyone, no matter what state you live in. You can exercise any of these rights the same way described in Section 7: through Account > Privacy, or by emailing {{PRIVACY_EMAIL}}.

## 9. How Long We Keep Your Information

| What | How Long |
|---|---|
| Account and profile data | While your account is active, then deleted or de-identified within 30 days of a deletion request |
| Home records, photos, and documents | Same as above |
| Messages you sent and reviews you wrote | Same as above; content already visible to another user, such as a pro you messaged, may remain in their own view, de-identified where possible, because it's also their record of that job |
| Invoices, subscription, and payment records | 7 years, for tax and accounting purposes |
...
You can permanently delete your account and its data any time, from Account > Privacy. Doing this:

- Permanently deletes your photos and documents from storage.
- Permanently deletes most of your database rows: your properties, home systems, maintenance tasks, issues, messages you sent, and more.
- Cannot be undone.

We retain a narrow set of records even after deletion, either because the law requires it or because deleting them would delete someone else's own information:
...
**Push notifications.** Turning push on, in your browser or the iOS app, stores a subscription record so we can ask your device's own push service to show you a notification. Only certain kinds of notifications are ever pushed, such as a message from a pro or homeowner, a new lead, or a weather or safety alert; routine reminders and digests only appear inside the app. You can turn push off any time in Account > Notifications, or in your device's own settings, either of which removes the subscription record.
...
{{BRAND}} uses a short list of first-party cookies needed to keep you signed in and support features like password reset, plus a handful of values in your browser's own local storage, such as your theme preference and your Ask {{BRAND}} chat history, which never leaves your browser. We do not use third-party advertising or analytics cookies, and California law does not require us to show you a cookie consent banner for the kind of cookies we actually use. See our full Cookie and Tracking Notice for the exact list of what we set, what each one does, and how to control it.

## 15. International Users and Where Your Data Is Stored

{{BRAND}} currently operates only in the United States, for homeowners in Orange County, California. Our servers and databases are located in the United States, and your information is stored and processed there. If you access {{BRAND}} from outside the United States, your information will still be transferred to, and processed in, the United States.

## 16. Changes to This Policy

We may update this policy as {{BRAND}} changes. We will always update the "Last updated" date at the top of this page. For a change that meaningfully affects what we collect, why, or who we share it with, we will also give you notice, such as an email to the address on your account or a notice inside the app, before it takes effect. Continuing to use {{BRAND}} after that means you accept the change.
...
If you have an account, you can also reach us from the in-app Help page.
