...
{{BRAND}} is a marketplace. Most of what appears on it, homeowner photos of homes and systems, uploaded documents, contractor logos, portfolio photos, quotes, and license or insurance files, is uploaded by users, not by us. We do not review material before it is posted. This notice-and-takedown process is how copyright owners tell us about infringing material so we can act on it.
...
Send notices only to this address. Notices sent elsewhere, including to general support, may be delayed or missed.
...
3. Identification of the material claimed to be infringing and information reasonably sufficient for us to locate it, ideally a direct link to the page on {{BRAND}}.
4. Information reasonably sufficient to let us contact you: name, address, telephone number, and, if available, an email address.
...
A notice missing one of these elements may not count as valid notice under the law, so please include all six. Our legal deadlines under Section 512 only run from a complete notice.

## 5. What we do after we receive a valid notice

We remove or disable access to the identified material. We take reasonable steps to tell the user who posted it, generally by forwarding a copy of the notice, including the contact information you gave us, to that user. We keep a record of the notice and our response.
...
We terminate, in appropriate circumstances, the accounts of homeowners or contractors who are repeat infringers. In practice this means an account can be suspended or permanently closed, and a contractor's public page taken down, after repeated valid takedown notices against that account. This is separate from, and in addition to, the account termination rights described in the Terms of Service.
...
This page and our designated agent only handle copyright infringement claims. Trademark disputes, privacy complaints, harassment, or other legal concerns should go to {{LEGAL_EMAIL}} instead. Sending a copyright notice about a non-copyright issue will not get it resolved faster.

## 10. Photo ownership: homeowners and pros

A homeowner's photos of their own home, systems, and issues belong to the homeowner. A contractor may only post job or project photos, including before-and-after photos, on their {{BRAND}} profile if they have the homeowner's permission to use those photos publicly. Posting a homeowner's photo without permission can be both a copyright and a privacy problem, and we treat a homeowner's report of either the same way: we look into it and can remove the material.
